...
import com.generation.projetogames.repository.CategoriaRepository;
import com.generation.projetogames.repository.ProdutoRepository;
...
public class ProdutoController {
	...
	private ResponseEntity<List<Produto>> getByPlataforma(@PathVariable String plataforma){
